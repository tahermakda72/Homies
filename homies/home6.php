	...
	<nav class="navbar navbar-default">
		...
		<!-- Brand and toggle get grouped for better mobile display -->
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="home6.php"><img src="images/houselogo.png" alt="logo"></a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">

				<ul class="nav navbar-nav navbar-left">
					<li><a href="home6.php" style="font-size:30px">Homies</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<form method="post">
					<input type="submit" name="logoutsubmit" value="Log Out" class="btn btn-default navbar-btn"/>
					</form>
				</ul>
